...
export class UsersController {
  ...
  async unfollow(@UserId() userId: number, @TypedParam('id', 'number') followeeId: number): Promise<true> {
  ...
  async follow(@UserId() userId: number, @TypedParam('id', 'number') followeeId: number): Promise<true> {
